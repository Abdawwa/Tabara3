...
$event_enrolled_query = "SELECT DISTINCT enrolled_events.event_id , events.event_name , events.event_description FROM `enrolled_events` INNER JOIN events ON enrolled_events.event_id = events.event_id WHERE `user_id`='$user_id'";
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-7">
                    <div class="card p-3 py-4">
                        ...
                        <div class="px-4 mt-1">
                            <span><h6>Email:</h6> <?php echo $info['user_email'] ?> </span>
                            <span><h6>Phone:</h6><?php echo $info['user_phone'] ?> </span>
                            <p class="fonts"></p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fullName" placeholder="Enter name" name="user_name"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="eMail" placeholder="Enter email ID" disabled
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="phone" placeholder="Enter phone number" name="user_phone"
                                           value="<?php echo $info['user_phone'] ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row gutters">
